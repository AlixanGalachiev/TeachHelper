...
Revision ID: 50139b3687b4
Revises: 
Create Date: 2025-08-26 07:04:27.359474
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('teacher', 'student', name='roleuser'), nullable=False),
    ...
    sa.Column('status', sa.Enum('draft', 'executing', 'checking', 'archived', name='workstatus'), nullable=False),
